...
data_file_path = "./msr/MSR_data_cleaned.csv"
json_out_file_path = "./msr/msr.json"
train_idxs_out_file = "./msr/train_msr.txt"
test_idxs_out_file = "./msr/test_msr.txt"
valid_idxs_out_file = "./msr/valid_msr.txt"
